...
INSERT INTO "new_JoinRequest" ("acknowledged", "createdAt", "gameId", "id", "updatedAt", "userId") SELECT "acknowledged", "createdAt", "gameId", "id", "updatedAt", "userId" FROM "JoinRequest";
